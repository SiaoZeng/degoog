...
SEARXNG_SECRET="${SEARXNG_SECRET:-degoog-searxng-local}"
SEARXNG_BIND_ADDRESS="${SEARXNG_BIND_ADDRESS:-127.0.0.1}"
SEARXNG_PORT="${SEARXNG_PORT:-8888}"
export SETTINGS ENGINES_TO_ENABLE SEARXNG_SECRET SEARXNG_BIND_ADDRESS SEARXNG_PORT
...
server_section["secret_key"] = os.environ["SEARXNG_SECRET"]
server_section["bind_address"] = os.environ["SEARXNG_BIND_ADDRESS"]
server_section["port"] = int(os.environ["SEARXNG_PORT"])
